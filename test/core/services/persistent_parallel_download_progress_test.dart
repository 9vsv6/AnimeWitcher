...
void main() {
  ...
  test('coalesces child progress into one parent update with aggregate ETA', () async {
    ...
    try {
      ...
      final progressUpdates = updates.whereType<TaskProgressUpdate>().toList();
  ...
  test('pause cancels a pending aggregate progress emission', () async {
    ...
    try {
      ...
      coordinator.handleUpdate(
        TaskStatusUpdate(child, TaskStatus.running),
      );
