# Contributing Translations to AnimeWitcher

Thank you for helping localize AnimeWitcher! Our localization system is fully automated. You only need to edit or add translation files—no code changes are required.
