    ...
    builder: (dialogContext) {
      return StatefulBuilder(
        builder: (context, setDialogState) {
          final defaultLocation = appText(
            context,
            english: 'System Downloads/Skystream',
            arabic: 'مجلد التنزيلات الافتراضي / Skystream',
          );
          return AlertDialog(
            title: Text(
              appText(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      appText(
                        context,
                        english: 'Queue limit: $concurrency at once',
                        arabic: 'حد الطابور: $concurrency معاً',
                      ),
                    ),
                    Slider(
                    ...
                    Text(
                      appText(
                        context,
                        english: 'Segments per file: $chunks',
                        arabic: 'أجزاء لكل ملف: $chunks',
                      ),
                    ),
                    Slider(
